"""
MIST AI Client — Helper Unificado de Inteligência Artificial
...
class AIClient:
    ...
    async def curate_recommendations(
        ...
        """
        # Extrai os títulos/IDs já possuídos
        ...
        if self.resolve_provider() != "mock":
            ...
            try:
                ...
                if isinstance(enriched, list) and len(enriched) > 0:
                    # Mapeia de volta aos objetos completos do catálogo
                    results = []
    ...
    async def generate_dynamic_quests(
        ...
        # Fallback Heurístico Determinístico do Quest Master
        return [
            {
    ...
    async def companion_chat_reply(
        ...
        # Fallback Heurístico Determinístico do Companion Bot

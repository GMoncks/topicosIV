...
class GameBase(BaseModel):
    ...
    developer: str = Field(..., max_length=100, description="Estúdio original desenvolvedor")
    publisher: str = Field(..., max_length=100, description="Plataforma origem (MIST Studios ou Steam Imported)")
